    ...
    return (
      <div className="flex items-center gap-2">
        <Link href="/profile" className="flex flex-col items-center justify-center text-slate-400 hover:text-white transition py-1 px-2">
          <div className="w-6 h-6 rounded-full bg-pro-slate-800 border border-pro-slate-600 flex items-center justify-center text-[10px] font-bold text-blue-400 ring-1 ring-blue-500/30">
            ME
          </div>
