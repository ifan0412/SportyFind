...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        // Updated: slate-800/80 footer bg + slate-700 border to match dark theme
        "-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t border-slate-700/50 bg-slate-800/80 p-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        // Updated: slate-100 for strong contrast
        "font-heading text-base leading-none font-semibold text-slate-100",
        className
      )}
      {...props}
    />
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        // Updated: slate-400 for consistent muted text
