...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        // Base layout
        "flex w-fit items-center justify-between gap-1.5 rounded-lg py-2 pr-2 pl-2.5 text-sm whitespace-nowrap transition-colors outline-none select-none",
        // Updated: slate dark border + background
        "border border-slate-700 bg-slate-800/60 text-slate-100",
        // Updated: placeholder text
        "data-placeholder:text-slate-500",
        // Updated: focus ring in blue slate
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn(
        // Updated: slate-400 for subtle group labels
        "px-1.5 py-1 text-xs text-slate-400",
        className
      )}
      {...props}
    />
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        // Updated: slate hover/focus state
    ...
    >
      <span className="pointer-events-none absolute right-2 flex size-4 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          {/* Updated: check icon in slate-300 */}
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn(
        // Updated: slate-700 separator line
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={cn(
        // Updated: slate-800 background for scroll buttons
        "z-10 flex cursor-default items-center justify-center bg-slate-800 py-1 text-slate-400 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
